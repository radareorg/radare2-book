...
Если настроены какие-либо [зоны флагов](../basic_commands/flags.html#flag-zones) (`fz?`), эта переменная позволит вам отобразить полосу прокрутки с флаг-зонами в визуальном режиме. Установите значение в `1`, чтобы отобразить полосу прокрутки справа, `2` для верхней части экрана и `3` - снизу.
