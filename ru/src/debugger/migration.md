...
| показать регистр | В окне регистров Windows | `dr all` | автоматом в визуальном режиме | `info registers` | `r` |
| распечатать eax | В окне регистров Windows | `dr?eax` | автоматом в визуальном режиме | `info registers eax` | `r rax` |
